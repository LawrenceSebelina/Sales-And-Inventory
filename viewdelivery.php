...
<head>
    ...
    <title>SALES AND INVENTORY SYSTEM</title>t>
          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-truck me-2"></i></span> Scheduled Deliveries
              </div>
                ...
                <div class="dropdown mt-4 pt-2 mb-4 mx-3">
                  <div class="input-group">
                    ...
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbspPending&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="viewdelivery_cancelled.php">Cancelled</a></li>
                    </ul>
                  </div>
                </div>
            ...
            Modal body delete end-->
              ...
              <div class="mx-5 mt-4"><div class='box red'></div><b>&nbsp— Deliveries that are not delivered in the scheduled time of delivery (Update delivery status)</b></div>                  
            <!--
                  ...
                  <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="delivery_details.php?receipt_no='.$row["receipt_no"].'">'.$row["transaction_id"].'</a>';?></td>
                            ...
                            <td><center>
                                <a name="editbtn" href="deliveryinfo_update.php?delivery_id=<?php echo $row['delivery_id'];?>" class="btn btn-primary" title="Update this delivery"><i class="fa-solid fa-pen-to-square"></i></a>
