...
<body>
    ...
    <main class="mt-5 pt-3">
          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                ...
                <span class="text-info">(Yearly)</span>
              </div>
              <div class="card-body">
                <div class="dropdown mb-4 mt-3">
                  <div class="input-group">
                    ...
                    <span class="input-group-text bg-dark text-light"><i class="fa-solid fa-calendar-days"></i></span>
                ...
                <div class="gap-3 d-md-flex justify-content-md-end mt-3 mb-4 mx-1">
                  <button type="button" title="Check yearly sales chart" class="btn btn-success fw-bold" data-bs-toggle="modal" data-bs-target="#yearlychart"><i class="fa-solid fa-chart-column me-2"></i>Yearly Sales Chart</button>
                </div>
                
            <!-- Modal yearly sales-->
              <div class="modal fade" id="yearlychart" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                  <div class="modal-content border-success border-2">
                    <div class="modal-header bg-success">
                      <span><i class="text-white"></i></span><h5 class="modal-title fw-bold text-white" id="exampleModalLabel"><i class="fa-solid fa-chart-column me-2"></i>Yearly Sales</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
            <!-- Modal yearly sales end-->

            <!-- Modal body yearly sales-->
      ...
      <?php 
         $sql13 ="SELECT YEAR(date) as dname, sum(total) as total from transaction_logs GROUP BY YEAR(date) DESC LIMIT 7";
