    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light border-secondary border-2" tabindex="-1" id="sidebar">
      <div class="offcanvas-body p-0">
        ...
        <div class="list-group mt-4 mb-3 d-grid gap-1">
            <a href="#" type="button" class="fw-bold list-group-item list-group-item-action active" aria-current="true"><span><i class="fa-solid fa-people-carry-box me-3"></i><?php echo $row13['transaction_id'];?></span></a>
            <a href="salestransac_logs.php" type="button" class="fw-bold list-group-item list-group-item-action"><span><i class="fa-solid fa-circle-left fa-lg me-3"></i>Back</span></a>
        </div>
        </nav>
      </div>
          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-people-carry-box me-2"></i></span>Transaction Logs > <?php echo $row13['transaction_id'];?>
              </div>
