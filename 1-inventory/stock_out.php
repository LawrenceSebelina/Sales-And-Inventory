              ...
              <div class="card-body">
                ...
                <span class="ms-4 fw-bold">Stock Type:</span>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="critical_stock.php">Critical</a></li>
                        <li><a class="dropdown-item" href="#">Fast moving</a></li>
                        <li><a class="dropdown-item" href="#">Slow moving</a></li>
                    </ul>
                </div>
                    ...
                    <tbody>
                      <?php
                        ...
                        <tr>
                          ...
                          <td class='bg-danger text-center text-white'><?php echo $row['quantity'] ?></td>
                        </tr>
                        <?php
                            }
                        }
