                  ...
                  <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="delivery_details_completed.php?receipt_no='.$row["receipt_no"].'">'.$row["transaction_id"].'</a>';?></td>
                            ...
                            <td><center>
                                <a name="editbtn" href="deliveryinfocompleted.php?delivery_id=<?php echo $row['delivery_id'];?>" class="btn btn-primary" title="View delivery information"><i class="fa-solid fa-table-list"></i></a>
