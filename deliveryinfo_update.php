    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light border-secondary border-2" tabindex="-1" id="sidebar">
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <div class="container bg-secondary"><br>
            <a class="navbar-brand">
              <center><span class="text-uppercase pd-2 mt-4 text-uppercase fw-bold h4"><i class="fa-solid fa-file-pen fa-sm me-2"></i>Update Delivery</span><br><span class="text-uppercase pd-2 mt-4 text-uppercase fw-bold h4">Information</span></center>
            </a>
          </div>
          <?php                    
            $id = $_GET['delivery_id'];
        ...
        <div class="list-group mt-4 mb-3 d-grid gap-1">
            <a type="button" class="fw-bold list-group-item list-group-item-action" aria-current="true"><span><i class="fa-solid fa-rectangle-list fa-lg me-3"></i><?php echo $row13['delivery_id'];?></span></a>
            <a href="viewdelivery.php" type="button" class="fw-bold list-group-item list-group-item-action"><span><i class="fa-solid fa-circle-arrow-left fa-lg me-3"></i>Back</span></a>
        </div>
        </nav>
      </div>
          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              ...
              <?php
                ...
                ?>  
                <form class="row g-3 ms-4 mx-4 mb-4 mt-2" action="delivery_update.php" method="POST" id="form_id">
                  <input type="hidden" class="form-control" id="delivery_id" name="delivery_id" value="<?php echo $row["delivery_id"]; ?>" required>
                    <div class="col-md-4">
                        ...
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-pen-clip"></i></span><input type="text" class="form-control" id="update_fname" name="update_fname" pattern="[a-zA-Z-ñ\s]+" title="First name must not contain any special characters or numbers." value="<?php echo $row['cust_fname'];?>" required></div>
                    </div>
                    <div class="col-4">
                        <label for="inputLastname" class="form-label fw-bold">Last Name</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-pen-clip"></i></span><input type="text" class="form-control" id="update_lname" name="update_lname" pattern="[a-zA-Z0-9-_.ñ\s]+" title="Last name must not contain any other special characters." value="<?php echo $row['cust_lname'];?>" required></div>
                    </div>
                    <div class="col-4">
                        <label for="inputContact" class="form-label fw-bold">Contact</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-phone"></i></span><input type="text" class="form-control" id="update_contact" name="update_contact" pattern="[0-9]{11}" title="Contact Number (Format: 09123456789)" value="<?php echo $row['cust_contact'];?>" required></div>
                    </div>

                    <div class="col-2">
                        <label for="inputBlock" class="form-label fw-bold">Block</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_block" name="update_block" pattern="[0-9]{1,6}" title="Block must not contain any letters or spaces." value="<?php echo $row["cust_block"]; ?>" required></div>
                    </div>
                    <div class="col-2">
                        <label for="inputLot" class="form-label fw-bold">Lot</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_lot" name="update_lot" pattern="[0-9]{1,6}" title="Block must not contain any letters or spaces." value="<?php echo $row["cust_lot"]; ?>" required></div>
                    </div>
                    <div class="col-5">
                        <label for="inputStreet" class="form-label fw-bold">Street</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_street" name="update_street" pattern="[a-zA-Z0-9-_.ñ\s]+" title="Street must not contain any other special characters." value="<?php echo $row["cust_street"]; ?>" required></div>
                    </div>
                    <div class="col-3">
                        <label for="inputBarangay" class="form-label fw-bold">Barangay</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_barangay" name="update_barangay" pattern="[a-zA-Z0-9-_.ñ\s]+" title="Barangay must not contain any special characters." value="<?php echo $row["cust_barangay"]; ?>" required></div>
                    </div>
                    <div class="col-md-3">
                        <label for="inputCity" class="form-label fw-bold">City</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_city" name="update_city" pattern="[a-zA-Z-_.ñ\s]+" title="City must not contain any special characters or numbers." value="<?php echo $row["cust_city"]; ?>" required></div>
                    </div>
                    <div class="col-md-3">
                      <label for="inputProvince" class="form-label fw-bold">Province</label>
                      <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_province" name="update_province" pattern="[a-zA-Z-_.ñ\s]+" title="Province must not contain any special characters or numbers." value="<?php echo $row["cust_province"]; ?>" required></div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <label for="inputOthers" class="form-label fw-bold">Other Address Info</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-house"></i></span><input type="text" class="form-control" id="update_others" name="update_others" pattern="[0-9]{1,6}" title="Zip must not contain any special characters, letters or spaces." value="<?php echo $row["cust_others"]; ?>"></div>
                    </div>
                    <hr>
                    <div class="col-5">
                    ...
                    <div class="col-4">
                        <label for="inputUpdateSchedDate" class="form-label fw-bold">Update Date</label>
                          <!-- min="<?= date('Y-m-d'); ?>" -->
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-calendar-days"></i></span><input type="date" class="form-control" id="update_scheduledate" name="update_scheduledate" value="<?php echo $row["date"]; ?>"></div>
                    </div>
                    <div class="col-3">
                        <label for="inputUpdateSchedTime" class="form-label fw-bold">Update Time</label>
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-clock"></i></span><input type="time" min="<?= date('TH:i'); ?>" class="form-control" id="update_scheduletime" name="update_scheduletime" value="<?php echo $row["time"]; ?>"></div>
                    </div>
                    <div class="col-5">
                    ...
                    <div class="col-5">
                        ...
                        <div class="input-group"><span class="input-group-text bg-dark text-light"><i class="fa-solid fa-square-poll-vertical"></i></span>
                    ...
                    <div class="col-12 d-md-flex justify-content-md-end">
                        <button type="submit" class="btn btn-primary fw-bold mx-2" name="updatedata"><i class="fa-solid fa-paper-plane me-2"></i>Save</button>
                        <button onClick="window.location.reload();" type="button" class="btn btn-danger fw-bold"><i class="fa-solid fa-ban me-2"></i>Cancel</button>
                    </div>
                </form>
