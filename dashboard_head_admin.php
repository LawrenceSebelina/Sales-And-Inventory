      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          ...
          <?php 
            ...
            <center><a class="navbar-brand text"><small class="text-uppercase text-uppercase fw-bold text-info"><?php echo $row['firstname'];?>&nbsp<?php echo $row['lastname'];}}}?></small><br><small class="text-uppercase text-uppercase fw-bold text-warning">Head Admin</small></a></center>
          </div>
        <div class="list-group mt-3 mb-3 d-grid gap-1">
            <button type="button" class="bi bi-speedometer list-group-item list-group-item-action active" aria-current="true"><span class="ms-3">Dashboard</span></button>
            <button onclick="window.location.href='1-inventory/manage_product.php'" type="button" class="bi bi-box-seam list-group-item list-group-item-action"><span class="ms-3">Inventory</span></button>
            <button onclick="window.location.href='2-sales/salestransac_logs.php'" type="button" class="bi bi-cash list-group-item list-group-item-action"><span class="ms-3">Sales</span></button>
            <button onclick="window.location.href='3-deliveries/monitor_deliveries.php'" type="button" class="bi bi-truck list-group-item list-group-item-action"><span class="ms-3">Deliveries</span></button>
            <button onclick="window.location.href='4-configuration/store_info.php'" type="button" class="bi bi-gear list-group-item list-group-item-action"><span class="ms-3">Configuration</span></button>
            <button onclick="window.location.href='5-reports/salestransac_report.php'" type="button" class="bi bi-bar-chart list-group-item list-group-item-action"><span class="ms-3">Reports</span></button>
            <button type="button" name="signout" onclick="out();" class="signout bi bi-box-arrow-right list-group-item list-group-item-action"><span class="ms-3">Sign Out</span></button>
        </div>
        </nav>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <div class="card border-danger border-2 text-white h-100">
              <div class="card-header bg-danger fw-bold"><span class="bi bi-basket">&nbsp&nbsp&nbspTotal Products</span></div>
                <?php
              ...
              <div class="card-footer bg-danger text-white d-flex justify-content-md-center">
                <a href="1-inventory/manage_product.php" style="text-decoration: none;" class="card-link text-white fw-bold">View Details <span class="ms-auto"><i class="bi bi-chevron-right"></i></span></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card border-primary border-2 text-white h-100">
              <div class="card-header bg-primary fw-bold"><span class="bi bi-cash">&nbsp&nbsp&nbspDaily Sales</span></div>
              <?php 
              ...
              <div class="card-footer bg-primary text-white d-flex justify-content-md-center">
                <a href="2-sales/monitor_sales_daily.php" style="text-decoration: none;" class="card-link text-white fw-bold">View Details <span class="ms-auto"><i class="bi bi-chevron-right"></i></span></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card border-success border-2 text-white h-100">
              <div class="card-header bg-success fw-bold"><span class="bi bi-bar-chart-line">&nbsp&nbsp&nbspCritical Stocks</span></div>
                <?php
              ...
              <div class="card-footer bg-success text-white d-flex justify-content-md-center">
                <a href="1-inventory/manage_stock.php" style="text-decoration: none;" class="card-link text-white fw-bold">View Details <span class="ms-auto"><i class="bi bi-chevron-right"></i></span></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card border-secondary border-2 text-white h-100">
              <div class="card-header bg-secondary fw-bold"><span class="bi bi-alarm">&nbsp&nbsp&nbspScheduled Delivery</span></div>
                <?php 
              ...
              <div class="card-footer bg-secondary text-white d-flex justify-content-md-center">
                <a href="3-deliveries/monitor_deliveries.php" style="text-decoration: none;" class="card-link text-white fw-bold">View Details <span class="ms-auto"><i class="bi bi-chevron-right"></i></span></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6 mb-3">
            <div class="card border-info border-2 h-100">
              ...
              <div class="card-footer bg-info d-flex justify-content-md-center">
                <a href="2-sales/monitor_sales_daily.php" style="text-decoration: none;" class="card-link text-dark fw-bold">View Details <span class="ms-auto"><i class="bi bi-chevron-right"></i></span></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-3">
            <div class="card border-warning border-2 h-100">
              ...
              <div class="card-footer bg-warning d-flex justify-content-md-center">
                <a href="1-inventory/manage_stock.php" style="text-decoration: none;" class="card-link text-dark fw-bold">View Details <span class="ms-auto"><i class="bi bi-chevron-right"></i></span></a>
              </div>
          </div>
