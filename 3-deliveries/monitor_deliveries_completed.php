          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-truck me-2"></i></span> Completed Delivery Status 
              </div>       
                ...
                <div class="dropdown mt-4 pt-2 mb-4 mx-3">
                  <div class="input-group">
                    ...
                    &nbsp&nbsp&nbsp Completed &nbsp&nbsp&nbsp
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="monitor_deliveries.php">Pending</a></li>
                        <li><a class="dropdown-item active" href="#">Completed</a></li>
                        <li><a class="dropdown-item" href="monitor_deliveries_cancelled.php">Cancelled</a></li>
                    </ul>
                  </div>
                </div>
              ...
              <!-- Modal body delete-->
                      <div class="modal-body">
                        <form class="row g-3 mt-2" action="archivedelivery_completed.php" method="POST">
                            ...
                            <textarea type="text" class="form-control border-danger border-2" id="reason" name="reason" placeholder="Reason for archiving..." pattern="[a-zA-Z0-9-_.ñ\s]+" title="Type the reason/s for archiving the delivery." required></textarea>
              ...
              <div class="card-body">
                ...
                <?php                    
                  ...
                  <?php
                    $query_search = "SELECT * FROM delivery WHERE status = 'Completed' AND delivery_status = 0 ORDER BY DATE(`date`) = CURDATE() DESC, status DESC, time ASC";
                    $query_run = mysqli_query($connection, $query_search);
                  ?>   
                  <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="deliverydetails_completed.php?receipt_no='.$row["receipt_no"].'">'.$row["transaction_id"].'</a>';?></td>
                            ...
                            <td><center>
                                <a name="editbtn" title="View delivery information" href="deliveryinfo_completed.php?delivery_id=<?php echo $row['delivery_id'];?>" class="btn btn-primary"><i class="fa-solid fa-table-list"></i></a>
