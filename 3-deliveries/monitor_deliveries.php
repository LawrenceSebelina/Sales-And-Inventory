          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-truck me-2"></i></span> Pending Delivery Status
              </div>       
              ...
              <div class="mx-5 mt-4"><div class='box orange'></div><b>&nbsp— Deliveries that are not delivered in the scheduled time of delivery (Update delivery status)</b></div>
                  ...
                  <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="deliverydetails.php?receipt_no='.$row["receipt_no"].'">'.$row["transaction_id"].'</a>';?></td>
                            ...
                            <td><center>
                                <a name="editbtn" title="Update this delivery" href="deliveryinfoupdate.php?delivery_id=<?php echo $row['delivery_id'];?>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
