          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-warehouse me-2"></i></span> Critical Level Stock
              </div>
              ...
              <div class="card-body">
                <div class="dropdown mb-4 mt-3">
                  <div class="input-group">
                    ...
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Critical &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    </button>
                    ...
                    <tbody>
                      <?php
                        ...
                        <tr>
                          ...
                          <td class='bg-warning text-end text-white'><?php echo $row['quantity'] ?></td>
                        </tr>
                        <?php
                            }
                        }
