          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-warehouse me-2"></i></span> Out of stock
              </div>
              ...
              <div class="card-body">
                <div class="dropdown mb-4 mt-3">
                  <div class="input-group">
                    ...
                    &nbsp&nbsp&nbsp&nbsp Out of stock &nbsp&nbsp&nbsp&nbsp
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="stock_report.php">Stock on hand</a></li>
                        <li><a class="dropdown-item bg-primary text-white" href="#">Out of stock</a></li>
                    ...
                    <tbody>
                      <?php
                        ...
                        <tr>
                          ...
                          <td class='bg-danger text-end text-white'><?php echo $row['quantity'] ?></td>
                        </tr>
                        <?php
                            }
                        }
