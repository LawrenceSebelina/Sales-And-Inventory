    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light border-secondary border-2" tabindex="-1" id="sidebar">
      <div class="offcanvas-body p-0">
        ...
        <div class="list-group mt-4 mb-3 d-grid gap-1">   
            ...
            <a href="#" type="button" class="fw-bold list-group-item list-group-item-action active" aria-current="true"><span><i class="fa-solid fa-truck me-3"></i>Deliveries</span></a>
          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-truck me-2"></i></span> Delivery Records
              </div>
                  ...
                  <table id="example" class="table table-striped" style="width: 100%">
                    <thead class="table-dark">
                      <tr>
                        ...
                        <th class="fw-bold text-uppercase text-center">Customer Name</th>
                    ...
                    <tbody>
                      <?php
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['cust_fname'] .'&nbsp'. $row['cust_lname'] ?></td>
                          <td align='center'><?php echo date('m/d/Y', strtotime($row['date']));?></td>
                          <td align='center'><?php echo date('h:m:s a', strtotime($row['date']));?></td>
