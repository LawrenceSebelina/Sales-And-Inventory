    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light border-secondary border-2" tabindex="-1" id="sidebar">
      <div class="offcanvas-body p-0">
        ...
        <div class="list-group mt-4 mb-3 d-grid gap-1">   
            ...
            <a href="#" type="button" class="fw-bold list-group-item list-group-item-action active" aria-current="true"><span><i class="fa-solid fa-boxes-stacked" style="margin-right: 1.1rem;"></i>Inventory</span></a>
            ...
            <a href="../dashboard.php" type="button" class="fw-bold list-group-item list-group-item-action"><i class="fa-solid fa-bars fa-lg" style="margin-right: 1.1rem;"></i><span>Menu</span></a>
        </div>
        </nav>
      </div>
          ...
          <div class="col-md-12 mb-3">
            <div class="card border-secondary border-2">
              <div class="card-header text-uppercase fw-bold fs-4 bg-secondary text-light">
                <span><i class="fa-solid fa-boxes-stacked me-2"></i></span> Product Inventory
              </div>
                    ...
                    <tbody>
                      <?php
                        ...
                        <tr>
                          ...
                          <td><?php echo date('m/d/Y', strtotime($row['product_date']));?></td>
                        </tr>
                        <?php
                            }
                        }
